...
<div class="page-container">
	...
	-gray mt-20"> <span class="l"> <a href="javascript:;" onclick="product_add('添加产品','/admin/img/{{$goods_id}}')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe6df;</i>添加</a>
		...
		@foreach($imgs as $img)
			<li class="item">
				<div class="portfoliobox">
						<input class="checkbox" name="img" type="checkbox" value="{{$img->id}}">
					<div class="picbox">
						<a href="{{$img->goods_url}}" data-lightbox="gallery" 	data-title="{{$imgInfo->goods_name}}"><img src="{{$img->goods_url}}"></a>
					</div>
				</div>
			</li>
		@endforeach
