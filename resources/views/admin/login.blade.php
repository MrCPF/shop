    ...
    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input type="ausers_name" name="ausers_name" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input type="password" name="ausers_password" type="ausers_password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
