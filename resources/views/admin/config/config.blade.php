			...
			<div class="tabCon">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						网站开关：</label>
					<div class="formControls col-xs-8 col-sm-9">
						        <label><input type="radio" name="open" value="0" class="" checked >&nbsp;&nbsp;开</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label><input type="radio" name="open" value="1" class=""  >&nbsp;&nbsp;关</label>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">备案号：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-icp" placeholder="京ICP备00000000号" value="ICP备00000000号" class="input-text">
					</div>
				</div>
				<div class="row cl">
        ...
        <input type="file" name="photo" value="" class="">
				...
				<div class="row cl" style="padding-left: 20px;">
					...
					<div style="padding-left:50px;">
						<img id="thumb" src="" width="200" height="200"></div>
        </td>
					</div>					
				</div>
			</div>
